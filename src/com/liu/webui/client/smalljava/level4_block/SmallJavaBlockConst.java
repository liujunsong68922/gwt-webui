package com.liu.webui.client.smalljava.level4_block;

/**
 * SmallJavaConst�������ַ��������Ķ��壬����ͳһ�ڳ���ĸ����ط������ַ����Ķ���
 * 
 * @author liujunsong
 *
 */
public class SmallJavaBlockConst {
	...
	/**
	 * MEMO:SubBlock������{}�պϵĲ���,SubBlock���Լ��ı�������ӽڵ㣬������Ҫ�������� MEMO:�������BracePlugin����
	 */
	public final static String SubBlock = "SubBlock";
	/**
	 * MEMO����һ�ı��ʽ��������ʽ���Լ��㣬��û���Լ��ı����� MEMO���������SemicolonPlugin����
	 */
