 ...
 *
 */
public class LogicGreaterEqualOperEvalPlugin implements IExpressionEval {
		...
		if (root instanceof DualOperDataOperElement) {
			...
			if (oper.getOpercode().equals(">=")) {
				...
				if (leftvar.getVartype().equals("int")) {
					...
					intoper.doGE(rightvar.getVarsvalue());
					return intoper;
				}
				if (leftvar.getVartype().equals("long")) {
					...
					longoper.doGE(rightvar.getVarsvalue());
					return longoper;
				}
				if (leftvar.getVartype().equals("float")) {
					...
					floatoper.doGE(rightvar.getVarsvalue());
					return floatoper;
				}
				if (leftvar.getVartype().equals("double")) {
					...
					doubleoper.doGE(rightvar.getVarsvalue());
					return doubleoper;
				}
